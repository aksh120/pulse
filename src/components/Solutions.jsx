  ...
  return (
    <section id="solutions" className="py-20 sm:py-28">
      <Container>
        ...
        {/* Content Box */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center p-6 sm:p-10 rounded-3xl bg-white dark:bg-[#13151C] border border-pulse-border dark:border-[#232630] shadow-card">
